...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-11dc47a7><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-11dc47a7></div><div class="max-w-520px text-center" data-v-11dc47a7><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-11dc47a7>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-11dc47a7>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.1_typescript@5.7.3_vite@6.0.7/node_modules/nuxt/dist/app/components/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-11dc47a7"]]);

export { error500 as default };
//# sourceMappingURL=error-500-R4Kazvg8.mjs.map
