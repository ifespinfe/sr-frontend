...
import { _ as _sfc_main$c } from './NuxtImg-CYc9Gd-X.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const liveEventRequests = computed(() => {
      var _a2;
      var _a, _b;
      return (_a2 = (_b = (_a = data.value) == null ? undefined : _a.data.live_event) == null ? undefined : _b.requests) != null ? _a2 : [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        _push(ssrRenderComponent(_component_LiveBanner, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              return [
                createVNode(_component_NuxtLink, {
                  to: `/${unref(route).params.host}/${(_f = (_e2 = (_d2 = unref(data)) == null ? undefined : _d2.data) == null ? undefined : _e2.live_event) == null ? undefined : _f.id}/make-a-request`
                }, {
                  default: withCtx(() => [
                    createVNode(_sfc_main$4, null, {
                      default: withCtx(() => [
      ...
      _push(ssrRenderComponent(_component_SharedBackButton, {
        to: "/audience",
        class: ("cn" in _ctx ? _ctx.cn : unref(cn))(((_e = unref(data)) == null ? undefined : _e.data.live_event) ? "mt-10" : "")
      }, null, _parent));
      _push(ssrRenderComponent(_component_SharedLoadingArea, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b2, _c2, _d2, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N;
          if (_push2) {
            if (unref(host)) {
              _push2(`<div class="grid grid-cols-1 md:grid-cols-[1fr_400px] justify-between gap-6 mt-10"${_scopeId}><div${_scopeId}><div class="grid lg:grid-cols-[auto_1fr] items-start gap-4"${_scopeId}>`);
              ...
              _push2(`<div class="flex items-center gap-1"${_scopeId}><span class="font-semibold"${_scopeId}>${ssrInterpolate((_f = unref(data)) == null ? undefined : _f.data.total_events)}</span><span class="text-muted-foreground"${_scopeId}>EVENTS</span></div></div><div class="flex items-center gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_SvgIcon, { name: "genres" }, null, _parent2, _scopeId));
              _push2(`<div class="flex items-center gap-1"${_scopeId}><span class="font-semibold"${_scopeId}>${ssrInterpolate((_g = unref(data)) == null ? undefined : _g.data.total_requests)}</span><span class="text-muted-foreground"${_scopeId}>REQUESTS</span></div></div><div class="flex items-center gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_SvgIcon, { name: "genres" }, null, _parent2, _scopeId));
              _push2(`<div class="flex items-center gap-1"${_scopeId}><span class="font-semibold"${_scopeId}>${ssrInterpolate((_h = unref(data)) == null ? undefined : _h.data.total_fulfilled_requests)}</span><span class="text-muted-foreground"${_scopeId}>FUFILLED</span></div></div></div><div class="flex flex-col md:flex-row items-center gap-4"${_scopeId}>`);
              ...
              if (((_i = unref(data)) == null ? undefined : _i.data.live_event) && !unref(ended)) {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  to: `/${unref(route).params.host}/${(_l = (_k = (_j = unref(data)) == null ? undefined : _j.data) == null ? undefined : _k.live_event) == null ? undefined : _l.id}/make-a-request`,
                  class: "w-full md:w-auto"
                }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
              ...
              _push2(`<div${_scopeId}><div class="text-lg font-semibold text-foreground"${_scopeId}>${ssrInterpolate((_m = unref(data)) == null ? undefined : _m.data.total_fulfilled_requests)} of ${ssrInterpolate((_n = unref(data)) == null ? undefined : _n.data.total_requests)}</div><div class="text-muted-foreground"${_scopeId}>Request fufilled</div></div></div></div></div><div${_scopeId}>`);
              if ((_p = (_o = unref(data)) == null ? undefined : _o.data) == null ? undefined : _p.live_event) {
                _push2(ssrRenderComponent(_sfc_main$2, {
                  event: (_r = (_q = unref(data)) == null ? undefined : _q.data) == null ? undefined : _r.live_event
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              ...
              _push2(ssrRenderComponent(_component_SvgIcon, { name: "badge" }, null, _parent2, _scopeId));
              _push2(`<div${_scopeId}><div class="text-lg font-semibold text-foreground"${_scopeId}>${ssrInterpolate((_s = unref(data)) == null ? undefined : _s.data.total_fulfilled_requests)} of ${ssrInterpolate((_t = unref(data)) == null ? undefined : _t.data.total_requests)}</div><div class="text-muted-foreground"${_scopeId}>Request fufilled</div></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(host) ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", null, [
                  createVNode("div", { class: "grid lg:grid-cols-[auto_1fr] items-start gap-4" }, [
                    createVNode(_sfc_main$5, {
                      class: "!size-[120px] md:!size-[180px] xl:!size-[200px] !rounded-3xl !text-4xl",
                      initials: ("getInitials" in _ctx ? _ctx.getInitials : unref(getInitials))((_u = unref(host)) == null ? undefined : _u.stage_name),
                      image: unref(host).profile_picture,
                      onClick: ($event) => ended.value = true
                    }, null, 8, ["initials", "image", "onClick"]),
                    createVNode("div", { class: "py-2" }, [
                      createVNode("div", { class: "font-display text-3xl md:text-4xl font-semibold" }, toDisplayString((_v = unref(host)) == null ? undefined : _v.stage_name), 1),
                      createVNode("div", { class: "flex flex-wrap gap-4 items-center my-4 mb-6" }, [
                        createVNode("div", { class: "flex items-center gap-2" }, [
                          ...
                          createVNode("div", { class: "flex items-center gap-1" }, [
                            createVNode("span", { class: "font-semibold" }, toDisplayString((_y = (_x = (_w = unref(data)) == null ? undefined : _w.data) == null ? undefined : _x.total_followers) == null ? undefined : _y.length), 1),
                        ...
                        createVNode("div", { class: "flex items-center gap-2" }, [
                          ...
                          createVNode("div", { class: "flex items-center gap-1" }, [
                            createVNode("span", { class: "font-semibold" }, toDisplayString((_z = unref(data)) == null ? undefined : _z.data.total_events), 1),
                        ...
                        createVNode("div", { class: "flex items-center gap-2" }, [
                          ...
                          createVNode("div", { class: "flex items-center gap-1" }, [
                            createVNode("span", { class: "font-semibold" }, toDisplayString((_A = unref(data)) == null ? undefined : _A.data.total_requests), 1),
                        ...
                        createVNode("div", { class: "flex items-center gap-2" }, [
                          createVNode(_component_SvgIcon, { name: "genres" }),
                          createVNode("div", { class: "flex items-center gap-1" }, [
                            createVNode("span", { class: "font-semibold" }, toDisplayString((_B = unref(data)) == null ? undefined : _B.data.total_fulfilled_requests), 1),
                      ...
                      createVNode("div", { class: "flex flex-col md:flex-row items-center gap-4" }, [
                        ...
                        ((_C = unref(data)) == null ? undefined : _C.data.live_event) && !unref(ended) ? (openBlock(), createBlock(_component_NuxtLink, {
                          key: 0,
                          to: `/${unref(route).params.host}/${(_F = (_E = (_D = unref(data)) == null ? undefined : _D.data) == null ? undefined : _E.live_event) == null ? undefined : _F.id}/make-a-request`,
                          class: "w-full md:w-auto"
                        }, {
                          default: withCtx(() => [
                            createVNode(_sfc_main$4, {
                  ...
                  createVNode("div", { class: "mt-10 space-y-2 text-muted-foreground hidden md:block" }, [
                    ...
                    createVNode("div", { class: "inline-flex bg-white/10 items-center rounded-xl py-4 px-6 gap-4" }, [
                      ...
                      createVNode("div", null, [
                        createVNode("div", { class: "text-lg font-semibold text-foreground" }, toDisplayString((_G = unref(data)) == null ? undefined : _G.data.total_fulfilled_requests) + " of " + toDisplayString((_H = unref(data)) == null ? undefined : _H.data.total_requests), 1),
                ...
                createVNode("div", null, [
                  ((_J = (_I = unref(data)) == null ? undefined : _I.data) == null ? undefined : _J.live_event) ? (openBlock(), createBlock(_sfc_main$2, {
                    key: 0,
                    event: (_L = (_K = unref(data)) == null ? undefined : _K.data) == null ? undefined : _L.live_event
                ...
                createVNode("div", { class: "mt-4 space-y-4 text-muted-foreground md:hidden" }, [
                  ...
                  createVNode("div", { class: "inline-flex bg-white/10 items-center rounded-xl py-4 px-6 gap-4" }, [
                    createVNode(_component_SvgIcon, { name: "badge" }),
                    createVNode("div", null, [
                      createVNode("div", { class: "text-lg font-semibold text-foreground" }, toDisplayString((_M = unref(data)) == null ? undefined : _M.data.total_fulfilled_requests) + " of " + toDisplayString((_N = unref(data)) == null ? undefined : _N.data.total_requests), 1),
                      createVNode("div", { class: "text-muted-foreground" }, "Request fufilled")
                    ])
                  ])
                ])
...
//# sourceMappingURL=index-CkBdc44q.mjs.map
