...
import { u as useHead$2 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-2daa6bb9><div class="fixed left-0 right-0 spotlight z-10" data-v-2daa6bb9></div><div class="max-w-520px text-center z-20" data-v-2daa6bb9><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-2daa6bb9>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-2daa6bb9>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-2daa6bb9>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.15.2_@parcel+watcher@2.5.0_@types+node@22.10.7_db0@0.2.1_ioredis@5.4.2_magicast@0.3.5__55lqgu7v5h4ti5ooit6fp5wlwm/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2daa6bb9"]]);

export { error404 as default };
//# sourceMappingURL=error-404-DV3O-Yg0.mjs.map
